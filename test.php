...
$array[$current_dir] = my_scan($folder_scan);
    ...
    foreach ($folder_scan as $key => $value) {
        ...
        if (is_array($value)) {
            if ($folder === "/" || substr($key, 0, 3) === "../") {
                echo '<div class="close"><span id="folder"><span> <img id="rotate" src="assets/img/ui/tree-indicator.svg" style="cursor: pointer;"></span><img src="assets/img/folder.png" style="cursor: pointer;"><span style="color: blue; cursor: pointer;">' . basename($key) . '</span></span>';
